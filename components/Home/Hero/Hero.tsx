      ...
      <div className="w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10 ">
        ...
        <div>
          ...
          <p className="text-sm sm:text-base md:text-lg font-medium text-gray-300">
            ...
            providing the best software solutions for your business.
          </p>
          {/* button */}
          <a href="#_" className="relative mt-8 inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
